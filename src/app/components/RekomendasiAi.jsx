...
const RekomendasiAi = ({jurusan,nilai}) => {
  ...
  return (
    <div className="w-[70%] m-auto bg-[url(/images/ellipse_1.png)] bg-cover bg-center bg-no-repeat p-4 rounded-3xl">
    <div className="flex">
      ...
      <div className="my-auto">
        <Button onClick={()=>geminiAPI()} className="text-white bg-blue-500 rounded-xl font-Poppins">
          Klik Disini Untuk Analisis Jurusan Dan Nilai Anda
        </Button>
       
      </div>
    </div>
    <div className=" rounded-3xl bg-slate-300 w-[100%] h-[300px] font-Poppins mt-4 p-4">
